...
func (_GnosisSafe *GnosisSafeTransactor) ValidTransaction(opts *bind.CallOpts, to common.Address, value *big.Int, data []byte, operation uint8, safeTxGas, baseGas, gasPrice *big.Int, gasToken, refundReceiver common.Address, signatures []byte) (bool, error) {
	var out []interface{}
	err := _GnosisSafe.contract.Call(opts, &out, "execTransaction", to, value, data, operation, safeTxGas, baseGas, gasPrice, gasToken, refundReceiver, signatures)
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GnosisSafeSafeModuleTransactionIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GnosisSafeSafeModuleTransaction)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GnosisSafeSafeModuleTransactionIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GnosisSafeSafeModuleTransactionIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_GnosisSafe *GnosisSafeFilterer) FilterSafeModuleTransaction(opts *bind.FilterOpts) (*GnosisSafeSafeModuleTransactionIterator, error) {
	...
	logs, sub, err := _GnosisSafe.contract.FilterLogs(opts, "SafeModuleTransaction")
	if err != nil {
		return nil, err
	}
	return &GnosisSafeSafeModuleTransactionIterator{contract: _GnosisSafe.contract, event: "SafeModuleTransaction", logs: logs, sub: sub}, nil
}
...
func (_GnosisSafe *GnosisSafeFilterer) WatchSafeModuleTransaction(opts *bind.WatchOpts, sink chan<- *GnosisSafeSafeModuleTransaction) (event.Subscription, error) {
	...
	logs, sub, err := _GnosisSafe.contract.WatchLogs(opts, "SafeModuleTransaction")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GnosisSafeSafeModuleTransaction)
				if err := _GnosisSafe.contract.UnpackLog(event, "SafeModuleTransaction", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GnosisSafeSafeMultiSigTransactionIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GnosisSafeSafeMultiSigTransaction)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GnosisSafeSafeMultiSigTransactionIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GnosisSafeSafeMultiSigTransactionIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_GnosisSafe *GnosisSafeFilterer) FilterSafeMultiSigTransaction(opts *bind.FilterOpts) (*GnosisSafeSafeMultiSigTransactionIterator, error) {
	...
	logs, sub, err := _GnosisSafe.contract.FilterLogs(opts, "SafeMultiSigTransaction")
	if err != nil {
		return nil, err
	}
	return &GnosisSafeSafeMultiSigTransactionIterator{contract: _GnosisSafe.contract, event: "SafeMultiSigTransaction", logs: logs, sub: sub}, nil
}
...
func (_GnosisSafe *GnosisSafeFilterer) WatchSafeMultiSigTransaction(opts *bind.WatchOpts, sink chan<- *GnosisSafeSafeMultiSigTransaction) (event.Subscription, error) {
	...
	logs, sub, err := _GnosisSafe.contract.WatchLogs(opts, "SafeMultiSigTransaction")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GnosisSafeSafeMultiSigTransaction)
				if err := _GnosisSafe.contract.UnpackLog(event, "SafeMultiSigTransaction", log); err != nil {
					return err
				}
				event.Raw = log
