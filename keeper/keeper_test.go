...
func testSafeSetInheritanceLock(ctx context.Context, require *require.Assertions, node *Node, removeId string, lock int, bondId string, rid, rhash, rraw string) string {
