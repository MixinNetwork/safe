...
func (s *SQLite3Store) Migrate(ctx context.Context) error {
	...
	query3 := "UPDATE ethereum_balances SET balance=? WHERE address=? AND asset_id=? AND safe_asset_id=?;\n"
	err = s.execOne(ctx, tx, query3, "74500000000000000000000", "0xA82bCC5b1942c3BF74C8eef18E1a6E0d8FAFA4cb", "c94ac88f-4671-3976-b60a-09064f1811e8", "b5a91ff6-a78b-3838-9fa5-225636c093d0")
	if err != nil {
		return err
	}
